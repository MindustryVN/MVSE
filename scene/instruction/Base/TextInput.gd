...
func _update(color : Color):
	...
	$Panel.size = (Vector2(Config.TEXT_BOX_WIDTH, Config.TEXT_BOX_HEIGHT))
	
	$Panel/LineEdit.position = (Vector2(Config.TEXT_BOX_WIDTH * 0.05, 0))
	$Panel/LineEdit.size = (Vector2(Config.TEXT_BOX_WIDTH * 0.95, Config.TEXT_BOX_HEIGHT))
