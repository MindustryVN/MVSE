class_name ControlRadarInstruction
extends Instruction
...
func setup():
	...
	add_component("text1", "CenterLabel", "line2").text = "from"
...
func get_content() -> Array:
	var from : String = get_component_value("from","turret1")
	...
	return ["radar " + target + " " + and1 + " " + and2 + " " + sort + " " + from + " " + order + " " + outputt]
